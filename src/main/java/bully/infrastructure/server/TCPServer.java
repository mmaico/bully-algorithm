...
public class TCPServer {
  ...
  private final ReceivedMessagesListener listener;

  public TCPServer(ReceivedMessagesListener listener) {
  ...
  public static void main(String[] args) throws IOException {
    TCPServer tcpServer = new TCPServer(request -> new Response("######## ---> RECEIVED\n"));

    System.out.println("SERVER started!");
    tcpServer.initServer(8686);
